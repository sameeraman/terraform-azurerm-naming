...
locals {
  ...
  az = {
    ...
    ai_foundry_hub = {
      name        = substr(join("", compact([local.prefix_safe, "aih", local.suffix_safe])), 0, 63)
      name_unique = substr(join("", compact([local.prefix_safe, "aih", local.suffix_unique_safe])), 0, 63)
      dashes      = false
      slug        = "aih"
      min_length  = 3
      max_length  = 63
    ...
    ai_foundry_project = {
      name        = substr(join("", compact([local.prefix_safe, "aip", local.suffix_safe])), 0, 63)
      name_unique = substr(join("", compact([local.prefix_safe, "aip", local.suffix_unique_safe])), 0, 63)
      dashes      = false
      slug        = "aip"
      min_length  = 3
      max_length  = 63
